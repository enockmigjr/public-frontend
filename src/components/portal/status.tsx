...
export function StatusBadge({ status }: { readonly status: Status }) {
  const tone = status === "WAITING_FOR_CUSTOMER" ? "bg-amber-100 text-amber-900" : status === "RESOLVED" || status === "CLOSED" ? "bg-emerald-100 text-emerald-900" : "bg-sky-100 text-sky-900";
