...
export function TicketTimeline({ ticketId }: { readonly ticketId: string }) {
  ...
  const query = useQuery({ queryKey: ["public-timeline", ticketId], queryFn: () => publicApi.timeline(ticketId), refetchInterval: 30_000 });
