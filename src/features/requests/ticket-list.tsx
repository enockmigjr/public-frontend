...
export function TicketList() {
  ...
  if (!tickets.length && page === 1) return <div><EmptyState title="Aucune demande pour le moment" description="Créez votre première demande : notre équipe pourra la qualifier et vous tenir informé ici." /><Link href="/nouvelle-demande" className="mx-auto mt-4 flex w-fit rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90">Créer une demande</Link></div>;
